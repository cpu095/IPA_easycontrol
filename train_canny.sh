...
export OUTPUT_DIR="/opt/liblibai-models/user-workspace/songyiren/FYP/sjc/redux/models/blurred_model_0412"  # your save path
...
CUDA_VISIBLE_DEVICES=4,5,6,7 accelerate launch --config_file $CONFIG train_resume.py \
    --pretrained_model_name_or_path $MODEL_DIR \
    --ip_adapter_path "/opt/liblibai-models/user-workspace/songyiren/FYP/sjc/FLUX-IPAdapter/ip-adapter.bin"\
    --pretrained_lora_path "/opt/liblibai-models/user-workspace/songyiren/FYP/sjc/redux/models/canny_model_0312/checkpoint-30000/lora.safetensors" \
    --cond_size=512 \
    --noise_size=1024 \
    --subject_column="None" \
